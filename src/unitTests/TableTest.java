...
public class TableTest {
    ...
    public void mini_project2_light() {
        ...
        Table table=new Table(90,200,20,3,4.6,3,
                8,new Vector(1,0,0),new Vector(0,-0.1,1),new Point3D(0,20,-400));
        scene.setCamera(new Camera(new Point3D(300, -25, -560), new Vector(-1, 0.2, 1).normalize(), new Vector(-0.1, -1, 0.1).normalize()
                ,4,1000,false));
        ...
        Floor floor= new Floor(new Point3D(307, 87.33596799730513, -537.731490265485)
                ,new Vector(0,-0.1,1),new Vector(1,0,0),
                40,2,new Color(100,100,100),Color.BLACK,new Material(0,0,200,0,0.6));
