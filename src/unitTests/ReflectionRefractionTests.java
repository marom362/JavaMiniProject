...
public class ReflectionRefractionTests {
    ...
    public void trianglesTransparentSphere() {
        ...
        scene.addGeometries( //
                new Triangle(new Color(0,0,0), new Material(0.5, 0.5, 60), //
    ...
    public void trianglesSphere() {
        ...
        scene.addGeometries( //
                new Plane(new Color(0,0,35), new Material(0, 0.8, 60,0,0), //
                        new Point3D(-150, 150, 115), new Point3D(150, 150, 135), new Point3D(75, -75, 150)), //

                new Sphere(new Color(java.awt.Color.CYAN), new Material(0.5, 0.5, 30,0,0.6), // )
                        45, new Point3D(0, -65, 130)),
                new Sphere(new Color(java.awt.Color.RED), new Material(0.5, 0.5, 30,0,0.6), // )
                        30, new Point3D(-10, 20, 75)),
                 new Sphere(new Color(java.awt.Color.green), new Material(0.5, 0.5, 30,0.6,0), // )
                               15, new Point3D(30, 60, 85)));
